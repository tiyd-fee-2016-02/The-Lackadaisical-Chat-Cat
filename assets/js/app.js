    ...
    if(e.which === 13) {
      ...
      for(var i = 0; i < userInput.length; i++){
        ...
        if (userInput[i].value.toLowerCase() == "hello"){
          ...
          $("ul").append("<li class='response'>Im 2 busy 2 teach u how 2 use dis app rite meow, please use @help if you don't know what you are doing.</li>")}, 1500)
        }
        else if (userInput[i].value.toLowerCase() == "goodbye"){
          window.setTimeout(function(){
          $("ul").append("<li class='response'>I gues itz tiem 2 go 2 sleep</li>")}, 1500)
        }
          ...
          window.setTimeout(function(){
          $("ul").append("<li class='response'>Dogs? Really? Get off my site.</li>")}, 1500)
        }
        else if (userInput[i].value.toLowerCase() === "help"){
          window.setTimeout(function(){
          ...
          window.setTimeout(function(){
          $("ul").append("<li class='response'>" + time + " = " + eval(time) + "</li>")}, 1500)
        }
